...
const EditScenarioModal = ({ scenario, aiProviders }: { scenario: Scenario; aiProviders: AiProvider[] }) => {
  ...
  return (
    <Modal.Root open={isOpen} onOpenChange={setIsOpen}>
      ...
      <Modal.Content className={'overflow-y-auto flex flex-col scrollbar-medium'}>
        ...
        <fetcher.Form method='PATCH' encType='multipart/form-data' className='w-full flex flex-col mt-[18px] h-full'>
          ...
          <Modal.Body className={'flex gap-4 md:gap-6 flex-1 flex-col'}>
            ...
            <div className='flex flex-col gap-4 w-full md:gap-6'>
              ...
              <div className={'grid gap-x-5 gap-y-6 w-full grid-cols-1 sm:grid-cols-2'}>
                <Input.Root>
