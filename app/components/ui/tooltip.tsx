      ...
      <TooltipPrimitive.Root open={open} defaultOpen={defaultOpen} onOpenChange={onOpenChange} delayDuration={delayDuration}>
        ...
        <TooltipPrimitive.Portal>
          <TooltipPrimitive.Content
            ...
            align={align}
            className={cn(
              'z-50 overflow-hidden break-words backdrop-blur-xl rounded-[10px] bg-neutral-03 px-3 py-2 font-semibold text-label text-base-black animate-tooltip fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
              className
            )}
            sideOffset={5}
          >
