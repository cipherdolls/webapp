          ...
          {isLoadingTokenPermits ? (
            <div className='flex items-center justify-center py-8'>
              <div className='flex items-center gap-2'>
                ...
                <span className='text-sm text-neutral-01'>Loading allowance history...</span>
              </div>
            </div>
            ...
            <div className='flex flex-col items-center justify-center py-8 gap-2'>
              ...
              <div className='text-center'>
                <h4 className='text-heading-h4 text-base-black'>No Allowance History</h4>
                <p className='text-body-md text-neutral-01'>No token allowance found.</p>
              </div>
            </div>
          ) : (
                  ...
                  <Accordion.Item value='details'>
                    ...
                    <Accordion.Content className='overflow-hidden data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down'>
                      <div className='flex flex-col gap-4 pt-[18px]'>
                        ...
                        <DetailRow title='Allowance ID' value={permit.id} />
