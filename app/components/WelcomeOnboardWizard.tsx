...
export const WelcomeOnboardWizard = ({ me }: { me: User }) => {
  ...
  return (
    <div
      className='mx-auto my-auto focus:outline-none max-w-[480px] bg-gradient-1 w-full rounded-xl px-4.5 shadow-bottom backdrop-blur-lg z-20 max-h-[80vh] overflow-y-auto sm:py-8 py-9 sm:px-10'
    >
      {currentStep === 'Welcome' && (
