  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        w-[375px] h-[514px] sm:w-[480px] sm:h-[322px] 
        ...
        [mask-composite:exclude]'
            style={{
              maskImage:
                "linear-gradient(to bottom, black 0%, black 100%), url(\"data:image/svg+xml,%3Csvg width='480' height='322' viewBox='0 0 480 322' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='480' height='322' rx='12' fill='black'/%3E%3C/svg%3E\")",
            }}
          />
        </Dialog.Overlay>
        ...
        <Dialog.Content className='fixed left-1/2 bottom-0 sm:bottom-auto sm:top-1/2 -translate-x-1/2 sm:-translate-y-1/2 focus:outline-none max-w-[480px] bg-[linear-gradient(86.23deg,rgba(254,253,248,0.56)_0%,rgba(255,255,255,0.56)_100%)] w-full rounded-xl sm:py-8 py-9 sm:px-12 px-4.5 shadow-bottom backdrop-blur-lg z-20'>
          ...
          <div className='flex flex-col sm:gap-4.5 gap-3'>
            ...
            <div className='flex flex-col gap-2'>
              <Dialog.Title className='sm:text-heading-h2 text-heading-h3 text-base-black text-center'>User Type</Dialog.Title>
              <Dialog.Description className='text-center sm:text-body-lg text-body-md text-base-black'>
                👌 Consumer - is all you need to chat with avatar and dolls. <br /> <br />
                😎 Producer - create your own avatars, public it, see system preferences.
              </Dialog.Description>
            </div>
