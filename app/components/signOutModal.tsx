...
const SignOutModal = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        <Dialog.Overlay asChild forceMount className='sm:bg-transparent bg-neutral-02 fixed inset-0 pointer-events-none z-30'>
          <motion.div
        ...
        <Dialog.Content asChild forceMount>
          <motion.div
            ...
            className='fixed left-1/2 bottom-0 sm:bottom-auto sm:top-1/2 -translate-x-1/2 sm:-translate-y-1/2 focus:outline-none max-w-[480px] bg-gradient-1 w-full rounded-xl sm:py-8 py-9 sm:px-12 px-4.5 shadow-bottom backdrop-blur-lg z-30'
          >
