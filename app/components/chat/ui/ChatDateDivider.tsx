...
const ChatDateDivider = ({ date }: { date: Date }) => {
  return (
    <div className='relative mb-6 flex justify-center text-heading-h1 before:content-[""] before:absolute before:inset-x-0 before:top-1/2 before:-translate-y-1/2 before:bg-neutral-04 before:h-[1px]'>
