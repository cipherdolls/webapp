          ...
          <div className='flex flex-col gap-10'>
            <div className='flex flex-col gap-4.5 items-center justify-center'>
              ...
              <div className='flex flex-col gap-2'>
                <h2 className='sm:text-heading-h2 text-heading-h3 text-base-black text-center'>Delete an Avatar?</h2>
                <p className='sm:text-body-lg text-base-black text-body-md text-center'>
                  By deleting an avatar a chat will be deleted as well. You will no able to restore the data
                </p>
              </div>
            </div>
