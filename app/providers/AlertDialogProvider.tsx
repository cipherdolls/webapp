...
export function AlertDialogProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <AlertDialogContext.Provider value={dialog}>
      ...
      >
        <Dialog.Portal>
          <Dialog.Overlay className='animate-overlay-show sm:bg-transparent bg-neutral-02 fixed inset-0 pointer-events-none z-[80]'>
            <div
        ...
        '
          ...
          <Dialog.Content className='animate-modal-show fixed left-1/2 bottom-0 sm:bottom-auto sm:top-1/2 -translate-x-1/2 sm:-translate-y-1/2 focus:outline-none max-w-[480px] bg-gradient-1 w-full rounded-xl pb-9 sm:py-8 sm:px-12 px-4.5 shadow-bottom backdrop-blur-lg z-90'>
