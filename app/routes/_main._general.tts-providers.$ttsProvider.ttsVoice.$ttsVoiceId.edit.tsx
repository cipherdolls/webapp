...
import type { Route } from './+types/_main._general.tts-providers.$ttsProvider.ttsVoice.$ttsVoiceId.edit';
...
export async function clientAction({ request, params }: Route.ClientActionArgs) {
  try {
    ...
    const res = await fetchWithAuth(`tts-voices/${params.ttsVoiceId}`, {
...
export async function clientLoader({ params }: Route.LoaderArgs) {
  const ttsVoiceId = params.ttsVoiceId;
