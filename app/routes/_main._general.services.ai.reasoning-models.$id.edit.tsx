...
export default function ReasoningModelEdit({ params }: Route.ComponentProps) {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    updateReasoningModel({ reasoningModelId: params.id, jsonData }, {
    ...
    >
      <Modal.Content>
        {reasoningModel ? (
          ...
          <p className='text-body-lg text-base-black text-center'>Reasoning model not found</p>
        )}
      </Modal.Content>
    </Modal.Root>
  );
